...
bool ptx_type_compatible_with_instruction(ptx_fundamental_type_t type, ptx_instruction_tag instruction);
...
bool ptx_instruction_is_half_precision(ptx_instruction_tag instruction);

// Check if an instruction is a texture fetch instruction
bool ptx_instruction_is_texture_fetch(ptx_instruction_tag instruction);

// Check if an instruction is a conversion instruction
bool ptx_instruction_is_conversion(ptx_instruction_tag instruction);
